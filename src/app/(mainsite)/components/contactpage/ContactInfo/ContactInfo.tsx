  ...
  return (
    <section className={styles.contactInfo}>
        <div className={styles.textContent}>
          ...
          <p>We’re located at <a href="https://maps.app.goo.gl/sbQGDQdbD2NS5VTs6" target="_blank">5705 East Tropicana Blvd. Las Vegas, Nevada 89122</a> and can also be reached by phone and email:</p>
